...
Min_Dist_for_track = 8; % in pixels - 6 pixels ~ worm body length
Min_Time_for_track = 5; % in seconds

Min_RadiusOfGyration_for_Track = 8; % in pixels - 6 pixels ~ worm body length
Max_Dist_for_run   = 600; % in pixels - 6 pixels ~ worm body length
Max_Time_for_run   = 600; % in seconds
Min_Dist_for_run   = 8; % in pixels - 6 pixels ~ worm body length
Min_Time_for_run   = 4; % in seconds


Min_average_velocity = 0.2; % pixels/second (average velocity: ~1 pixel/sec) 

Max_average_velocity = 5;   % pixels/second (average velocity: ~1 pixel/sec) 
