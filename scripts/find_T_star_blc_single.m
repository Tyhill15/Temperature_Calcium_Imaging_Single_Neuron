...
for m = 1:numel(files)
    ...
    [fret_pks, fret_locs] = findpeaks(del_F(recip_x:end),'minpeakheight', 0.5, 'minpeakdistance', 20);
...
new_file = ('T_star_numbers_');
save([dir_of_files '/' new_file geno_name], 'fret', 'temp', 'total_fret_amps', 'T_star_temps', 'mean_peak_diff');
